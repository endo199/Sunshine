...
import com.suhendro.sunshine.app.data.WeatherContract.WeatherEntry;
import com.suhendro.sunshine.app.data.WeatherProvider;
...
//    }
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor cursor = resolver.query(WeatherContract.LocationEntry.CONTENT_URI, projection, WeatherContract.LocationEntry.COLUMN_LOCATION_SETTING + " = ?", selectionArgs, null);
        if(cursor.moveToFirst()) {
            ...
            Uri uri = resolver.insert(WeatherContract.LocationEntry.CONTENT_URI, value);
